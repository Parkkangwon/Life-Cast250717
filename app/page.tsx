...
function Starfield({ explode }: { explode: boolean }) {
  ...
  useEffect(() => {
    ...
    }, 2500 + Math.random() * 1500); // 2.5~4초마다 위치 변경
...
export default function AIAutobiographyGenerator() {
  ...
  if (!isStarted) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-gradient-to-br from-[#4b2e0e]/90 to-[#2d1a05]/95">
        {/* 별빛 반짝임 효과 */}
  ...
  if (showBlogSettings) {
    if (!currentUser) {
      return (
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#4b2e0e]/90 to-[#2d1a05]/95 p-4">
  ...
  if (isGeneratingImages) {
    return (
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#ffe5c2] via-[#ffd6a7] to-[#fffbe6] flex items-center justify-center p-4">
        <div className="absolute inset-0 z-0 bg-gradient-to-br from-[#ffe5c2] via-[#ffd6a7] to-[#fffbe6]" />
...
const AutobiographyDisplay: React.FC<AutobiographyDisplayProps> = ({ sections, images, onBack, imageStyle }) => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#4b2e0e]/90 to-[#2d1a05]/95">
      <Starfield explode={false} />
      <div className="max-w-4xl mx-auto">
